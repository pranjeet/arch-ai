...
- **[CodeRabbit](https://jsm.dev/arch-coderabbit)** is an AI-powered code review assistant that automates pull request analysis. It provides line-by-line feedback, suggests code improvements, summarizes changes, and helps maintain high code quality by integrating seamlessly into your git-based development workflow.
...
```bash
git clone https://github.com/adrianhajdin/arch-ai.git
cd arch-ai
```
...
Replace the placeholder values with your real credentials. You can get these by signing up at: [**Clerk**](https://jsm.dev/arch-clerk), [**Liveblocks**](https://jsm.dev/arch-liveblocks), [**Trigger.dev**](https://jsm.dev/arch-triggerdev), [**Google AI Studio**](https://aistudio.google.com/).
